package com.bookdemo.actiondriver;

import com.bookdemo.actioninterface.ActionInterface;
...
public class MyActions extends BaseClass implements ActionInterface {
...
//        WebDriverWait wait = new WebDriverWait(driver,timeOut);
    ...
    public String screenShot(WebDriver driver, String filename) {
        ...
        String relDestination = "/Screenshots/" + filename + "_" + dateName + ".png";
        String destination = System.getProperty("user.dir") + relDestination;
